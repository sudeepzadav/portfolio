...
const Portfolios = () => {
  ...
  return (
    <div className="bg-gray-100 dark:bg-dark py-14 px-4 sm:px-8 lg:px-16 flex flex-col items-center justify-center gap-8 transition-colors duration-300">
      ...
      <div className="py-16 px-6 bg-gray-100 dark:bg-gray-900 transition-colors">
          ...
          {reactCards.map((card) => (
            ...
            >
              <div className="mb-4 flex justify-center">
                <img src={card.image} alt="" className="w-60 h-40 object-contain group-hover:scale-110 transition-transform duration-300"/>
              </div>
